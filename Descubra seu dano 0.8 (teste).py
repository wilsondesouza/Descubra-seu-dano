...
console = Console()
console.print('"[cyan]J[/][red]o[/][blue]g[/][green]a[/][red]t[/][black]i[/][magenta]n[/][blue]a[/] [red]d[/][gree]o[/][black]s[/] [green]P[/][magenta]u[/][blue]t[/][gree]o[/][red]s[/]" [bright_red]a[/][bright_blue]p[/][bright_magenta]r[/][bright_green]e[/][bright_red]s[/][bright_cyan]e[/][bright_red]n[/][bright_blue]t[/][bright_magenta]a[/]')
time.sleep(1)
...
def dano():
    ...
    for i in track(range(3), description='Calculando...'):  
...
def buffs():
    ...
    for i in track(range(2), description='Calculando...'):  
        print('Calculando %d.' %i)
        time.sleep(0.3)
