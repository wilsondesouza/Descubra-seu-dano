...
class Calculadora {
    ...
    atualizarResultados() {
        document.getElementById("calculoBase").textContent = this.dano_base.toFixed(2);
        document.getElementById("calculoBuff").textContent = this.dano_buff.toFixed(2);
        document.getElementById("calculoBoss").textContent = this.hit_boss.toFixed(2);
    }
}
