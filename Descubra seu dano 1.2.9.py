                    ...
                    if boss_usuario == 'Toadstool' or boss_usuario == 'Klaus' or boss_usuario == 'Klaus Enraged' or boss_usuario == 'Eye of Terror':
                        ...
                        match variação:
                            ...
                            case '2':
                                ...
                                s(1)
                            case '3':
                                boss = (Dicionários.chefes[boss_usuario][2])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1)
                        ...
                        match variação:
                            case '1':
                                boss = (Dicionários.chefes['Crab King'][0])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1)                       
                            case '2':
                                boss = (Dicionários.chefes['Crab King'][1])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1)   
                            case '3':
                                boss = (Dicionários.chefes['Crab King'][2])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1)                       
                            case '4':
                                boss = (Dicionários.chefes['Crab King'][3])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1) 
                            case '5':
                                boss = (Dicionários.chefes['Crab King'][4])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1)
                            case '6':
                                boss = (Dicionários.chefes['Crab King'][5])
                                hit_boss = boss
                                hit_boss = hit_boss / self.buff
                                s(1)    
                    hit_boss = boss
